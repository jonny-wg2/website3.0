  ...
  return (
    <Layout title="wgtwo">
      <div className={common.page}>
        ...
        <div className={`${common.section} ${common.sectionDark} ${common.sectionLessBottom} ${styles.caseStudySection}`}>
          <div className={common.container}>
            <CaseStudyList />
          </div>
        </div>
        <div className={`${common.section} ${common.sectionDark} ${styles.caseStudySection}`}>
          <div className={`${common.container} ${common.splitContainer}`}>
            <div className={common.text}>
              <div className={common.title}>Don't see your business case study in the list?</div>
              <div className={common.subtitle}>We love to solve your business problems of all sizes! </div>
            </div>
