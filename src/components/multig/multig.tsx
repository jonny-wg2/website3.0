    ...
    <div className={`${common.section} ${common.sectionGray}`}>
      <div className={`${common.container} ${common.splitContainer}`}>
        <div className={common.text}>
          <section><div className={common.pillTitle}>2G</div> <div className={common.pillTitle}>3G</div> <div className={common.pillTitle}>4G</div> <div className={common.pillTitle}>5G</div></section>
